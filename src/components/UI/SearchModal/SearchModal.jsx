const SearchModal = () => {
    ...
    return (<>
        <div className="search-modal-list ">
            ...
            <input className="search-modal-list__input" type="text" placeholder="search for a title" value=""/>
            <div className="search-modal-list__close-btn">
                <i className="fas fa-times" />
            </div>
            </div>

        <h3 className="search-modal-list__title">
